            ...
            <div class="col-md-8 py-1"> 
                    <div id="groupArea" style="padding: 5px;border: 1px solid #6ab04c;background-color: white; border-radius: 10px;">
                        ...
                        <div id="codeArea" style="display:none">
                            ...
                            <center>
                            Get verfication code here<br>
                            <button id="getCode" type="button" class="btn btn-success">Get Code</button><br>
                            (voting System will send a  verification code to your email)
                            </center>
                            </div>
                            <form>
