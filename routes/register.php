                ...
                <div id="regSection" class="text-center">
                    <form id="regForm" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-2">
                             <input name="voter_id" id="voter_id" type="text" class="form-control" placeholder="Voter ID" maxlength="12" pattern="[a-zA-Z0-9]+" title="Please enter alphanumeric characters only" required>
                        </div>
                    ...
                    <div id="loginSection" class="form-row py-6">
